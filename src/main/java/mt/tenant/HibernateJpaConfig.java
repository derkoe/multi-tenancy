...
public class HibernateJpaConfig
{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory()
    {
        ...
        jpaProperties.put("hibernate.tenant_identifier_resolver", TenantIdentifierResolver.class.getName());
        ...
        jpaProperties.put("hibernate.multi_tenant_connection_provider", new TenantConnectionProvider(dataSourceMap));
